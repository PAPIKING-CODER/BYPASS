...
import { bypassLimiter, authLimiter } from "./lib/rate-limits";
export { bypassLimiter, authLimiter };
...
// Bypass-specific rate limit: 10 req / min per IP (bypass is expensive)
...
// Auth rate limit: 20 req / 10 min per IP
